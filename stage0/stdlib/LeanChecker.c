...
lean_inc(v___y_77_);
v___x_82_ = l_Lean_importModulesCore(v_imports_81_, v___y_74_, v___y_77_, v___y_78_, v___x_80_);
...
v___x_85_ = 0;
v___x_86_ = l_Lean_finalizeImport(v___x_83_, v_imports_81_, v___x_84_, v___x_85_, v___y_75_, v___y_75_, v___y_74_, v___x_69_);
lean_dec(v___x_83_);
...
_start:
{
uint8_t v___y_5456__boxed_415_; lean_object* v_res_416_; 
v___y_5456__boxed_415_ = lean_unbox(v___y_411_);
v_res_416_ = l_List_forIn_x27_loop___at___00main_spec__5___redArg(v___y_5456__boxed_415_, v_as_x27_412_, v_b_413_);
...
_start:
{
uint8_t v___y_5704__boxed_588_; size_t v_sz_boxed_589_; size_t v_i_boxed_590_; lean_object* v_res_591_; 
v___y_5704__boxed_588_ = lean_unbox(v___y_582_);
v_sz_boxed_589_ = lean_unbox_usize(v_sz_584_);
lean_dec(v_sz_584_);
v_i_boxed_590_ = lean_unbox_usize(v_i_585_);
lean_dec(v_i_585_);
v_res_591_ = l___private_Init_Data_Array_Basic_0__Array_forIn_x27Unsafe_loop___at___00main_spec__4(v___y_5704__boxed_588_, v_as_583_, v_sz_boxed_589_, v_i_boxed_590_, v_b_586_);
...
_start:
{
uint8_t v___y_6079__boxed_774_; lean_object* v_res_775_; 
v___y_6079__boxed_774_ = lean_unbox(v___y_768_);
v_res_775_ = l_List_forIn_x27_loop___at___00main_spec__5(v___y_6079__boxed_774_, v_as_769_, v_as_x27_770_, v_b_771_, v_a_772_);
