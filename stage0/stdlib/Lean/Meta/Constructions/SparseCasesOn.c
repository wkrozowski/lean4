...
lean_inc_ref(v_toEnvExtension_2383_);
v_asyncMode_2384_ = lean_ctor_get(v_toEnvExtension_2383_, 2);
lean_inc(v_asyncMode_2384_);
lean_dec_ref(v_toEnvExtension_2383_);
