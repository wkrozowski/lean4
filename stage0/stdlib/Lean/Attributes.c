...
lean_object* x_16; 
lean_dec_ref(x_13);
x_16 = l_Lean_setEnv___at___00Lean_registerParametricAttribute_spec__4___redArg(x_11, x_14);
lean_dec(x_14);
return x_16;
}
else
