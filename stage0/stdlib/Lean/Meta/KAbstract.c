...
lean_dec_ref(x_4);
lean_dec(x_3);
x_29 = lean_obj_once(&l_Lean_Meta_kabstract___closed__0, &l_Lean_Meta_kabstract___closed__0_once, _init_l_Lean_Meta_kabstract___closed__0);
