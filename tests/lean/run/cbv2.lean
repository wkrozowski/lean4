...
/-- info: 3 -/
#guard_msgs in
#eval aeval (λ _ => 2) (.PLUS (.VAR 0) (.MINUS (.VAR 0) (.CONST 1)))
...
def Euclidean_division :=
  .ASSIGN 0 (.VAR 2) ;;
  .ASSIGN 1 (.CONST 0) ;;
  .WHILE (.LESSEQUAL (.VAR 2) (.VAR 0))
    (.ASSIGN 0 (.MINUS (.VAR 0) (.VAR 2)) ;;
     .ASSIGN 1 (.PLUS (.VAR 1) (.CONST 1)))
...
theorem cbv_test1 : aeval (λ _ => 2) (.PLUS (.VAR 0) (.MINUS (.VAR 0) (.CONST 1))) = 3 := by
  conv =>
    lhs
    cbv
  rfl
