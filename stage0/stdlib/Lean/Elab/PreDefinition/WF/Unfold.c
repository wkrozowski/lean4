...
lean_inc_ref(v_inheritedTraceOptions_5208_);
lean_inc(v_cancelTk_x3f_5206_);
lean_inc(v_currMacroScope_5205_);
lean_inc(v_quotContext_5204_);
lean_inc(v_maxHeartbeats_5203_);
lean_inc(v_initHeartbeats_5202_);
lean_inc(v_openDecls_5201_);
lean_inc(v_currNamespace_5200_);
lean_inc(v_ref_5199_);
lean_inc(v_currRecDepth_5198_);
