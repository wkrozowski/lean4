...
x_13 = lean_obj_once(&l_Lean_Meta_getListLitOf_x3f___redArg___closed__0, &l_Lean_Meta_getListLitOf_x3f___redArg___closed__0_once, _init_l_Lean_Meta_getListLitOf_x3f___redArg___closed__0);
x_14 = lean_box(0);
