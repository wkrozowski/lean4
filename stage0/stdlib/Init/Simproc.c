...
lean_inc(v___y_758_);
v___x_781_ = l_Lean_mkIdent(v___y_758_);
...
lean_inc(v_val_825_);
lean_dec_ref_known(v_doc_x3f_803_, 1);
...
lean_inc(v___y_863_);
v___x_885_ = l_Lean_mkIdent(v___y_863_);
...
lean_inc(v_val_929_);
lean_dec_ref_known(v_doc_x3f_907_, 1);
...
lean_inc(v___y_969_);
v___x_988_ = l_Lean_mkIdent(v___y_969_);
...
lean_dec_ref_known(v_doc_x3f_1010_, 1);
...
lean_dec_ref_known(v_pre_x3f_1162_, 1);
...
lean_dec_ref_known(v___y_1695_, 1);
