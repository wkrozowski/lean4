...
if (v___x_712_ == 0)
{
lean_dec(v_last_706_);
v_val_696_ = v_next_702_;
goto v___jp_695_;
}
else
{
lean_dec(v_next_702_);
...
if (v___x_813_ == 0)
{
lean_dec(v_last_807_);
v_val_797_ = v_next_803_;
goto v___jp_796_;
}
else
{
lean_dec(v_next_803_);
