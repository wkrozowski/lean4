...
v___x_596_ = lean_array_get_borrowed(v___x_591_, v_es_590_, v_j_595_);
lean_dec(v_j_595_);
...
v___x_10861__overap_849_ = lean_panic_fn_borrowed(v___f_848_, v_msg_814_);
lean_dec_ref(v___f_848_);
lean_inc(v___y_818_);
