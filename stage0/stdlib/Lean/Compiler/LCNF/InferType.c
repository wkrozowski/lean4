...
lean_inc_ref(v_toFunctor_2092_);
...
v___x_2684_ = lean_array_get_borrowed(v___x_2677_, v_alts_2671_, v___x_2683_);
lean_dec_ref(v___x_2677_);
...
lean_inc_ref(v_toFunctor_2746_);
