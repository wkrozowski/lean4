...
lean_dec(x_1);
x_157 = lean_obj_once(&l_Lean_Elab_Tactic_Conv_evalConv___closed__9, &l_Lean_Elab_Tactic_Conv_evalConv___closed__9_once, _init_l_Lean_Elab_Tactic_Conv_evalConv___closed__9);
