...
lean_dec(x_12);
lean_dec_ref(x_10);
x_45 = lean_obj_once(&l_Lean_Elab_Command_elabCheckAssertions___closed__18, &l_Lean_Elab_Command_elabCheckAssertions___closed__18_once, _init_l_Lean_Elab_Command_elabCheckAssertions___closed__18);
